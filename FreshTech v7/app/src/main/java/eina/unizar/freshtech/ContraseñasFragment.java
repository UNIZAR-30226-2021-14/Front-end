...
public class ContraseñasFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        names = new ArrayList<>();
        names.add("Contraseña 1");
        names.add("Contraseña 2");
        names.add("Contraseña 3");
        names.add("Contraseña 4");
        names.add("Contraseña 5");
        names.add("Contraseña 6");
        names.add("Contraseña 7");
        names.add("Contraseña 8");
        names.add("Contraseña 9");
        names.add("Contraseña 10");
