...
public class PopupOrdenar extends AppCompatDialogFragment {
    ...
    public interface onListaOrdenada {
        void ordenarListado();
    }
    public onListaOrdenada mOnListaOrdenada;
        ...
        builder.setView(view)
                ...
                .setPositiveButton("GUARDAR", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        guardarPreferencias();
                        mOnListaOrdenada.ordenarListado();
                    }
                });
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
                mOnListaOrdenada = (onListaOrdenada) context;
        } catch (ClassCastException e) {
            throw new ClassCastException(context.toString() + "OnListaOrdenada");
        }
    }
}
