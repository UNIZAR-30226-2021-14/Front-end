...
public class PrincipalActivity extends AppCompatActivity implements PopupOrdenar.onListaOrdenada {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_contraseñas, R.id.nav_documentos, R.id.nav_imagenes, R.id.nav_categorias, R.id.popupContacto, R.id.configuracionFragment, R.id.loginActivity)
    ...
    public void onClickOrdenar(MenuItem item) {
        ...
        if(actualFragment instanceof CategoriasFragment) {
            return;
        }*/
