...
public class ImagenEdit extends AppCompatActivity implements PopupCategoria.OnCategoriaCreadaEdit {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Fecha expiración
        huecoFechaExpiracion = findViewById(R.id.huecoFechaExpiracionImagen);
        ...
        if(extras != null) {
            ...
            if(extras.getString("verImagen") != null) {
                // NO PERMITIR EDITAR
                setTitle("Ver imagen");
                huecoFechaExpiracion = findViewById(R.id.huecoFechaExpiracionImagen);
                añadirCategoria = findViewById(R.id.imageButton);
                botonGuardar = findViewById(R.id.guardarImagen);
                ...
                nombreImagen.setTextColor(getResources().getColor(R.color.grisOscuro));;
            ...
            call.enqueue(new Callback<ElementoDetalladoImagen>() {
                ...
                public void onResponse(Call<ElementoDetalladoImagen> call, Response<ElementoDetalladoImagen> response) {
                    if(response.isSuccessful()) {
                        ...
                        Log.d("onResponse getPic", "Mensaje => not successful");
                ...
                public void onFailure(Call<ElementoDetalladoImagen> call, Throwable t) {
                    Log.d("onFailure getPic", "Mensaje => No ha funcionado");
                    Toast.makeText(ImagenEdit.this, "Error onFailure", Toast.LENGTH_SHORT).show();
                }
            });
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_GALLERY) {
            if (resultCode == Activity.RESULT_OK && data != null) {
                ...
                Log.d("SubriImagen: ", "Mensaje => " + realPath);
    ...
    private String getRealPathFromUri(Uri uri) {
        ...
        for (int i = 0; i<prueba.length;i++) {
            Log.d("SubriImagen: ", "Mensaje => " + prueba[i]);
        }
    ...
    private boolean writeResponseBodyToDisk(ResponseBody body) {
        try {
            ...
            File futureStudioIconFile = new File(Environment.getExternalStorageDirectory().getAbsoluteFile() + "/Download/" + nombreEditar + ".jpg");
