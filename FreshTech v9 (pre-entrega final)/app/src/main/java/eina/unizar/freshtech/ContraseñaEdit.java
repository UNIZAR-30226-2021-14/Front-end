...
public class ContraseñaEdit extends AppCompatActivity implements PopupCategoria.OnCategoriaCreadaEdit, PopupGenerar.DialogListener, Callback<Registrar> {
    ...
    public void onClickCopiarURL(View view) {
        ClipData clip = ClipData.newPlainText("URL contraseña", url.getText().toString());
        ClipboardManager clipboard = (ClipboardManager)this.getSystemService(CLIPBOARD_SERVICE);
        clipboard.setPrimaryClip(clip);
        Toast.makeText(this, "URL copiada al portapapeles", Toast.LENGTH_SHORT).show();
    }

    public void onClickCopiarNombreUsuario(View view) {
        ClipData clip = ClipData.newPlainText("Usario contraseña", nombreUsuario.getText().toString());
        ClipboardManager clipboard = (ClipboardManager)this.getSystemService(CLIPBOARD_SERVICE);
        clipboard.setPrimaryClip(clip);
        Toast.makeText(this, "Usuario copiado al portapapeles", Toast.LENGTH_SHORT).show();
    }

    public void onClickCopiarContraseña(View view) {
        ClipData clip = ClipData.newPlainText("Contraseña", contraseña.getText().toString());
        ClipboardManager clipboard = (ClipboardManager)this.getSystemService(CLIPBOARD_SERVICE);
        clipboard.setPrimaryClip(clip);
