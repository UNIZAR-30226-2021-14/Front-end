...
public class ConfiguracionActivity extends AppCompatActivity implements Callback<Registrar> {
    ...
    private static final int ACTIVITY_VERIFICAR_ACTUALIZAR=1;
    private static final int ACTIVITY_VERIFICAR_ELIMINAR=2;
    ...
    public void onClickActualizarContraseña(View view) {
        ...
        if(awesomeValidation.validate()) {
            ...
            i.putExtra("verificar_para", "actualizarContraseña");
            startActivityForResult(i, ACTIVITY_VERIFICAR_ACTUALIZAR);
        }
    }
    ...
    public void onClickEliminarCuenta(View view) {
        Intent i = new Intent(this, VerificacionActivity.class);
        i.putExtra("verificar_para", "eliminarCuenta");
        startActivityForResult(i, ACTIVITY_VERIFICAR_ELIMINAR);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        super.onActivityResult(requestCode, resultCode, data);
            if(resultCode == Activity.RESULT_OK){
                if(data.getStringExtra("result").equals("actualizarContraseña")) {
                    actualizarContraseña();
                }
                else if(data.getStringExtra("result").equals("eliminarCuenta")) {
                    eliminarCuenta();
                }
            }
    }
