...
public interface ApiService {
    ...
    @Multipart
    @POST("addFile")
    Call<Registrar> anyadirDocumento(
            @Header("Authorization") String Authorization,
            @Part("nombre") RequestBody nombreDocumento,
            @Part("categoria") RequestBody categoria,
            @Part("file\"; fileName=\"myFile.pdf\" ") RequestBody requestBodyFile,
            @Part("fechacreacion") RequestBody fechaCreacion,
            @Part("fechacaducidad") RequestBody fechaCaducidad
    );

    @GET("getFile")
    Call<ElementoDetalladoImagen> obtenerElementoDocumento(
            @Header("Authorization") String Authorization,
            @Query("nombre") String nombre
    );
    ...
    @GET("{nombreDocumento}")
    Call<ResponseBody> descargarDocumento(@Path("nombreDocumento") String nombreDocumento);
    ...
    @FormUrlEncoded
    @POST("editCat")
    Call<Registrar> editarCategoria(
            @Header("Authorization") String Authorization,
            @Field("nomCatAntigua") String nombreViejo,
            @Field("nomCatNueva") String nombreNuevo
    );
